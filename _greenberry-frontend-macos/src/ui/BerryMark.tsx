...
export function BerryMark({ size = 16 }: { size?: number }) {
  return (
    ...
    >
      ...
      {/* Shift the artwork up so the round BODY (the visual mass) sits at the
          optical center; the thin crown overflows above like an ascender.
          Without this the body hangs ~1.3px below adjacent text at size 16. */}
